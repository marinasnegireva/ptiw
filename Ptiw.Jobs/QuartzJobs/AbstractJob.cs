...
namespace Ptiw.Jobs.QuartzJobs
{
    ...
    {
        public AbstractJob(ILogger<IJob> logger, IConfiguration configuration, JobMonitor jobMonitor)
        {
            Logger = logger;
        ...
        public void Exit()
        {
            ...
            {
                observer.OnNext(new JobCompletionData { ChangesWereMade = ChangesWereMade, JobName = GetType().Name });
            }
